...
<div class="x-nav">
    <button type="button"   class="layui-btn layui-btn-sm " onclick="payments()">
        选中后付款
    </button>
...
<script>
    layui.use([ "element", "laypage", "layer", "upload","table"], function() {
        ...
        var tableIns = table.render({
            ...
            ,dataType:'json'
            ,method:'post'
            ,url: '${pageContext.request.contextPath}/getStuStoreOutByUserId' //后台springmvc接收路径
            ...
            ,cols: [
                [
                    {type: 'checkbox'}
                    ,{field:'stoo_id',title:'学生的出库单号', sort: true}
                    ...
                    ,{field:'book_out', title:'学生已领教材'}
                    ,{field:'book_back', title:'学生退还教材'}
                    ,{field:'total', title:'学生剩余教材'}
        ...
        layui.use('table',function(){
            ...
            if(checkStatus.data.length>0){//强制用户选择该行复选框
                ...
                layer.open({
                    ...
                    shade: 0.8,
                    area:  ['700px', '450px'],
                    content: 'stu_back_book?num='+book_id,
                    end: function(){
