...
<div class="x-body">
    <table id="teach_store_view" lay-filter="teach_store_view"></table>
</div>
...
<script>
    layui.use([ "element", "laypage", "layer", "upload","table"], function() {
        ...
        var tableIns = table.render({
            elem: '#teach_store_view'  //绑定table表格
            ,id:'teach_store_view'
            ,dataType:'json'
            ,method:'post'
            ...
            ,cols: [
                [
                    ...
                    ,{field:'book_out', title:'教师已领教材'}
                    ,{field:'book_back', title:'教师退还教材'}
                    ,{field:'total', title:'教师剩余教材'}
    ...
    function back_book() {
        ...
        layui.use('table',function(){
            var table = layui.table
            var checkStatus = table.checkStatus('teach_store_view');
            ...
            if(checkStatus.data.length>0){//强制用户选择该行复选框
                ...
                layer.open({
                    ...
                    shade: 0.8,
                    area:  ['700px', '450px'],
                    content: 'teach_back_book?num='+book_id,
                    end: function(){
